-- Some databases recorded 20260905080000 for an earlier golden-fruit repair,
-- so the thumbnail access migration with that version was skipped. Reapply
-- its read-only repair under a new version without changing migration history.
